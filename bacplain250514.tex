...
\hfill
\subfloat[Messung der Aussenkontur $\qquad \qquad \qquad \qquad \qquad \qquad \qquad \qquad \qquad$  \label{fig:messvdkd}]{\includegraphics[scale=.0418]{messvdkd}}
\hfill
...
\newpage
\begin{sidewaystable}[H]
\caption{Materialverzug im Vergleich zum Vorprozess (Polieren/Exolieren). Mit einem durchschnittlichen Verzug von \SI{0.3432}{\milli\meter} weichen die Maße der Aussenkontur des F18er Materials am höchsten vom Vorprozess Streckbiegen ab. F17 weist mit einem durchschnittlichen Verzug von \SI{0.2537}{\milli\meter} die kleinste Diskrepanz zum vorherigen Bearbeitungsschritt auf.}
\label{tab:biegfraes}
\vskip\abovecaptionskip
\footnotesize
