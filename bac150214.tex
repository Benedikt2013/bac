...
\subsection{Rekristallisation}
Ein wichtiger Faktor bei der Formänderung in metallischen Werkstoffen ist die Umformtemperatur und die thermisch aktivierten Vorgänge die diese eventuell im atomaren Gitterverband des Werkstoffes auslöst. Während eines Umformvorgangs erhöht sich stufenweise der Energiegehalt des Werkstoffmaterials. Dies ist größtenteils durch Versetzungen und plastische Verzerrungen im Gitterverband bedingt. Die Versetzungsdichte steigert sich direkt proportional zu dem Umformgrad. Bei fortgeschrittenem Umformgrad gerät durch den erhöhten Energieaufwand Wärme in das Material was bewirkt, dass sich die Atome wieder dem Gleichgewichtszustand annähern wollen.
...
Das Fertigungsprinzip Kröpfen  ist bei der Firm DURA im  Laufe der Jahre immer weiter Optimiert worden. Die mechanischen Vorgänge sind für einen Aussenstehenden aufgrund der kompakten Bauweise der Kröpfheinheiten zunächst schwer zu durchschauen. Eine sehr vereinfachte Prinzipsdarstellung ist zum Verständnis sehr hilfreich {siehe \fref{fig:krpfgesamt})
\begin{figure}[hbtp]
\centering
\includegraphics[scale=1]{krpfgesamt.png}
\caption{Kröpfen prinzipiell mit Schnitten in der Umformzone}
\label{fig:krpfgesamt}
\end{figure}
Das Ausgangsmaterial wird zunächst auf den \emph{Kröpfstein} gelegt danach wird es durch einen Niederhalter fixiert bevor der \emph{Ziehstempel} herunterfährt und das Bauteil 
\begin{figure}[hbtp]
\centering
\includegraphics[scale=.8]{krpfsequenz}
