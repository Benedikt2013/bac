...
\label{fig:messw2}
\end{figure}
Die Messwerte der neuen Chargen sind in \fref{fig:messw2} visualisiert. Dort ist zu sehen, dass das Fxx Material (rot) an den Stellen MP1a (\SI{0,121}{\milli\meter}), MP3a (\SI{0,028}{\milli\metre}),  MP7a (\SI{0,012}{\milli\meter}) MP8a (\SI{0,020}{\milli\meter}) und MP10a (\SI{0,104}{\milli\meter}) die geringsten Prozessschwankungen (Standardabweichung) hat.  
