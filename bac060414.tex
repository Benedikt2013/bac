...
\item \emph{Verformungseigenspannungen} (siehe \fref{fig:eigenspanfaser} und \fref{fig:eigenspandrahtzieh}) welche durch inhomogene Verformung auf Grund äußerer Beanspruchung verursacht werden.\begin{figure}
  ...
  \caption[Eigenspannungsveteilung Drahtziehen]{Schematische Tangentialeigenspannungsverteilung beim Drahtziehen in Abhängigkeit von der Ziehdüsenentfernung\protect\footnotemark}
...
mit einer einhergehenden Volumenänderung ausgelöst werden.\begin{figure}
  ...
  \caption[Volumenänderung durch Veränderung der Gitterstrucktur]{Volumenänderung durch Veränderung der Gitterstruktur\protect\footnotemark}
