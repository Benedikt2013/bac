...
\end{figure}
\end{description}
Bei der Kröpfversuchsreihe brachte keine Materialkombination der Wirkteile bessere Resultate als die herkömmliche Paarung Stahl/Stahl (Kröpfstein/Ziehstempel). Eine Übersicht ist in \fref{tab:kropfversuche} dargestellt.
