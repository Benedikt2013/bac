...
\centering
\hfill
\subfloat[Audi A3 \label{fig:audia3}]{\includegraphics[scale=.305]{audia314}}
\hspace{2.4cm}
\subfloat[Audi A3 Verdeckkastendeckel \label{fig:audia3verdeck}]{\includegraphics[scale=.573]{audia3verd}}
\hfill
\caption[Audi A3 Endprodukt]{Audi A3 Endprodukt\footnotemark }
\label{fig:audia3}
\end{figure}
 \footnotetext{Vgl.http://www.motorvision.de/images/3/0/2/8/0/9/958x645\%2B768x432\%2B-82x-169\%2B725/Audi\_A3\_Cabrio\_2014\_Heck.jpg und  http://www.cars.co.za/motoring\_news/2014-audi-a3-cabriolet-completes-the-a3-family/6061/[28.12.2013].}
...
\centering
\hfill
\subfloat[Kröpfung mit Fräsbereich  \label{fig:kropffrasbereich}]{\includegraphics[scale=.7]{kropffrasbereich}}
\hspace{2.4cm}
\subfloat[Kröpfung \label{fig:kropfung}]{\includegraphics[scale=.14]{kropfung}}
\hfill
...
\centering
\hfill
\subfloat[Messlehre  \label{fig:messlehre}]{\includegraphics[scale=.0854]{Messlehre}}
\hfill
