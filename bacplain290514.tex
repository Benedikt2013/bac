...
\titlehead{Fachhochschule Südwestfalen\\
...
\begin{figure}[hbtp]
\centering
\includegraphics[width=.6\textwidth]{F13Bieg}
\caption{•}
\end{figure}
\begin{figure}[hbtp]
\centering
\includegraphics[width=.6\textwidth]{FxxBieg}
\caption{•}
\end{figure}
\begin{figure}[hbtp]
\centering
\includegraphics[width=.6\textwidth]{F17Bieg}
\caption{•}
\end{figure}
